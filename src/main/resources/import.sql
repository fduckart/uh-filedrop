insert into message (MSG_ID, MSG_ENABLED, MSG_TYPE_ID, MSG_TEXT) values (1, 'Y', 1, '<span style="color: red;"><strong>WARNING: Not intended for normal use (test-env)</strong></span><br/>Welcome to the University of Hawai''i FileDrop application.');
...
insert into filedrop (id, uploader, uploader_fullname,created, upload_key,download_key, encrypt_key, valid_until, is_valid, require_auth) values (0, 'test', 'Test', '2019-11-14T08:30:18.023', 'uploadKey', 'downloadKey', 'encryptionKey', '2019-11-15T08:30:18.023', true, true);
insert into filedrop (id, uploader, uploader_fullname,created, upload_key,download_key, encrypt_key, valid_until, is_valid, require_auth) values (1, 'test', 'Test', '2019-11-14T08:30:18.023', 'uploadKey2', 'downloadKey2', 'encryptionKey2', '2019-11-15T08:30:18.023', true, false);
insert into filedrop (id, uploader, uploader_fullname,created, upload_key,download_key, encrypt_key, valid_until, is_valid, require_auth) values (2, 'jwlennon@hawaii.edu', 'John W Lennon', '2019-11-14T08:30:18.023', 'uploadKey3', 'downloadKey3', 'encryptionKey3', '2019-11-15T08:30:18.023', true, true);

insert into recipient (id, filedrop_id, name) values (1, 0, 'test');
insert into recipient (id, filedrop_id, name) values (2, 1, 'test');
insert into recipient (id, filedrop_id, name) values (3, 2, 'krichards@example.com');