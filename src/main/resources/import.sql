...
insert into filedrop (id, uploader, uploader_fullname,created,recipient, upload_key,download_key, encrypt_key, valid_until, is_valid, require_auth) values (2, 'jwlennon@hawaii.edu', 'John W Lennon', '2019-11-14T08:30:18.023', '[krichards@example.com]', 'uploadKey3', 'downloadKey3', 'encryptionKey3', '2019-11-15T08:30:18.023', true, true);