insert into message (MSG_ID, MSG_ENABLED, MSG_TYPE_ID, MSG_TEXT) values (1, 'Y', 1, '<span style="color: red;"><strong>THIS IS TEST</strong></span><br/>Welcome to the University of Hawai''i FileDrop application.');
