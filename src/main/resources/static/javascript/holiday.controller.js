(function() {
    ...
    function HolidayJsController($scope, dataProvider) {
        const URL_HOLIDAY_LOAD = '/filedrop/api/holidays';
        $scope.years = [];
    ...
    filedropApp.controller("HolidayJsController", HolidayJsController);
    ...
    filedropApp.controller("HolidayGridJsController", HolidayGridJsController);
